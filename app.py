...
from app.eSignature import views as esignature_views
from app.docusign.views import ds
from app.api_type import EXAMPLES_API_TYPE
from app.rooms import views as rooms_views
from app.click import views as click_views
from app.monitor import views as monitor_views
from app.admin import views as admin_views
from app.connect import views as connect_views
from app.webforms import views as webforms_views
from app.views import core

from app.docgen import docgen
...
app.register_blueprint(docgen.dapp)
